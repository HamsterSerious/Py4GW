...
class TeamComposer:
    ...
    def load_team_with_mandatory_heroes(self, party_size, profile_heroes, mandatory_list, 
                                       mission_name, get_assigned_hero_fn, get_hero_name_fn=None):
        """
        ...
        Args:
            ...
            mandatory_list: List of requirement dicts from mission
    ...
    def load_build_to_hero(self, hero_id, build_code):
        """
