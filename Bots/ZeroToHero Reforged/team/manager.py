...
class TeamManager:
    ...
    def save_config(self):
        ...
        if self.config.save():
            ...
            # Explicitly update the UI with the new names
            if self._ui:
                self._ui.refresh_hero_options(self._hero_options)
    
    # ==================
    # TEAM LOADING (Generators for use with AddCustomState)
    # ==================
    ...
    def load_team(self, party_size: int, mode: str = "NM"):
        ...
        This is a generator - use with bot.States.AddCustomState() or
        yield from in other generators.
    ...
    def load_team_with_mandatory_heroes(self, party_size: int, mode: str,
        ...
        This is a generator - use with bot.States.AddCustomState().
